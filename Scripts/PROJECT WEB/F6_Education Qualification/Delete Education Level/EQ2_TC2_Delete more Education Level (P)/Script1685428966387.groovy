...
WebUI.click(findTestObject('Object Repository/PROJECT WEB/Education Level/Page_OrangeHRM/button_Save'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Education Level/Page_OrangeHRM/div_SuccessSuccessfully Saved'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Education Level/Page_OrangeHRM/button_Diploma'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Education Level/Page_OrangeHRM/button_Yes, Delete'))

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Education Level/Page_OrangeHRM/div_SuccessSuccessfully Deleted'))
