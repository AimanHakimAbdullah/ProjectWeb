...
WebUI.setText(findTestObject('PROJECT WEB/Job Titles/input_Job Title'), 'Lead')

WebUI.setText(findTestObject('PROJECT WEB/Job Titles/textarea_Job Description_JT'), 'Supervise People')

WebUI.uploadFile(findTestObject('PROJECT WEB/Job Titles/div_InputFile'), 'C:\\Users\\Aiman Hakim\\Downloads\\Free_Test_Data_10.5MB_PDF.pdf')

WebUI.setText(findTestObject('PROJECT WEB/Job Titles/textarea_For Note_JT'), 'Good Luck')

WebUI.click(findTestObject('Object Repository/PROJECT WEB/Job Titles/button_Save'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Job Titles/span_Attachment Size Exceeded_JT'), 0)
