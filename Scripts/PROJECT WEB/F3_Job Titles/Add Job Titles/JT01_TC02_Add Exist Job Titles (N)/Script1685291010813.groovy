...
WebUI.uploadFile(findTestObject('PROJECT WEB/Job Titles/div_InputFile'), 'C:\\Users\\Aiman Hakim\\Downloads\\Job Description Dummy.pdf')
...
WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Job Titles/span_Already exists_JT'), 0)
