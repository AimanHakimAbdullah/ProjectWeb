...
WebUI.setText(findTestObject('PROJECT WEB/Job Titles/input_Job Title'), '')
...
WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Job Titles/span_Required_JT'), 0)
