...
WebUI.click(findTestObject('PROJECT WEB/Pay Grade/button_USD_delete Currency'))
...
WebUI.click(findTestObject('PROJECT WEB/Pay Grade/span_AED - Utd. Arab Emir. Dirham'))

WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/input_Minimum Salary'), '3000')

WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/input_Maximum Salary'), '30000')
