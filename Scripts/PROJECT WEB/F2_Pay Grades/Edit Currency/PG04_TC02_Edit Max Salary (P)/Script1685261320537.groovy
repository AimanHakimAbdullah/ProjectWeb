...
'Dynamic URL'
WebUI.navigateToUrl(GlobalVariable.URL_PAYGRADE)

WebUI.click(findTestObject('PROJECT WEB/Pay Grade/button_United States Dollar_Edit Currency'))

WebUI.doubleClick(findTestObject('PROJECT WEB/Pay Grade/input_Maximum Salary'))

WebUI.sendKeys(findTestObject('PROJECT WEB/Pay Grade/input_Maximum Salary'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('PROJECT WEB/Pay Grade/input_Maximum Salary'), Keys.chord(Keys.DELETE))

WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/input_Maximum Salary'), '70000')

WebUI.click(findTestObject('PROJECT WEB/Pay Grade/button_Save_AddCurrency'))

WebUI.click(findTestObject('PROJECT WEB/Pay Grade/p_Successfully Saved'))
