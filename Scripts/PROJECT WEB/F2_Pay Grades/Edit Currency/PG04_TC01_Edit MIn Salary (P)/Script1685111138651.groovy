...
WebUI.doubleClick(findTestObject('PROJECT WEB/Pay Grade/input_Minimum Salary'))

WebUI.sendKeys(findTestObject('PROJECT WEB/Pay Grade/input_Minimum Salary'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('PROJECT WEB/Pay Grade/input_Minimum Salary'), Keys.chord(Keys.DELETE))
